...
This application calculates payroll using custom overtime rules, piece‑rate logic, job‑pay, and hourly wages, all driven by a user‑friendly question system.

The Payroll App can operate in two modes:
...
• Employee Management:
  ...
  - Supports hourly, piece‑rate, and job‑pay employee types
...
• Payroll Calculation:
  The Payroll App automatically calculates:
  - Regular hours
  - Overtime hours
  - Double‑time hours
  - Piece‑rate earnings
...
• Keep CRM databases clearly named to avoid confusion  
